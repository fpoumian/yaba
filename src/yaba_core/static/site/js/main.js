...
var _LastFmTrack = __webpack_require__(1);

var _LastFmTrack2 = _interopRequireDefault(_LastFmTrack);
...
var LastFmAPI = function () {
   ...
   */
  function LastFmAPI(key, username, limit) {
  ...
  _createClass(LastFmAPI, [{
    key: 'fetchUserRecentTracks',
    value: function fetchUserRecentTracks(complete, success, error) {
    ...
    key: 'validateResponseData',
    value: function validateResponseData(data, onError, onSuccess) {
      if (data.error) {
    ...
    key: 'filterResponseData',
    value: function filterResponseData(data, callback) {
      var filteredData = data.recenttracks.track.map(function (track) {
        return new _LastFmTrack2.default(track);
      });
...
var _LastFmScrobblesTable = __webpack_require__(7);

var _LastFmScrobblesTable2 = _interopRequireDefault(_LastFmScrobblesTable);
...
var Modal = function () {
  function Modal(toggle, target) {
    ...
    this._bodySelector = (0, _jquery2.default)('.modal-body');
  ...
  _createClass(Modal, [{
    ...
    set: function set(value) {
      if (value == 'scrobbles') {
        this._content = new _LastFmScrobblesTable2.default(this._bodySelector);
      }
...
var _LastFmAPI = __webpack_require__(2);
...
(0, _jquery2.default)('document').ready(function () {
  ...
  var modal = new _Modal2.default((0, _jquery2.default)('.js-modal'), (0, _jquery2.default)('#modal'));

  // Last.FM API
  var lastFmAPIKey = window.lastFmConfig.getApiKey() || null;
  var username = window.lastFmConfig.getUsername() || null;
  var limit = window.lastFmConfig.getLimit() || 10;
  var lastFmAPI = new _LastFmAPI2.default(lastFmAPIKey, username, limit);

  // Modal event handlers
  modal.toggle.on('click', function () {
    modal.contentType = (0, _jquery2.default)(this).data('modal-content');
    modal.open();
  });
  ...
  modal.target.on('shown.bs.modal', function () {
    ...
    // success callback
    function (rawData) {
      _LastFmAPI2.default.validateResponseData(rawData,
      ...
      function (validRawData) {
        _LastFmAPI2.default.filterResponseData(validRawData, function (filteredData) {
    ...
    // error callback
    function (error) {
      var errorMessage = error.responseJSON.message || 'There was an unspecified error while making this request.';
...
var HTMLTable = function () {
   ...
   */
  function HTMLTable(parentDOMElement) {
    _classCallCheck(this, HTMLTable);

    this._parentDOMElement = parentDOMElement;
    this._topElement = (0, _jquery2.default)('<table>');
    this._topElement.addClass('table table-stripped');
    this._head = (0, _jquery2.default)('<thead>').append((0, _jquery2.default)('<tr>'));
    this._body = (0, _jquery2.default)('<tbody>');
  ...
  _createClass(HTMLTable, [{
    ...
    value: function setColumns() {
      ...
      if (this._columns.constructor !== Array) throw TypeError('Not an array');

      this._columns.forEach(function (column) {
        var $th = (0, _jquery2.default)('<th>');
        $th.html(column);
        _this._head.find('tr').append($th);
      });
    }
    ...
    value: function addRows() {
      ...
      if (this._data.constructor !== Array) throw TypeError('data property of table is not an array');

      this._data.forEach(function (item) {

        if (item.constructor !== _this2._rowItemType) throw TypeError('invalid item type for table row');
...
var _HtmlTable2 = __webpack_require__(6);

var _HtmlTable3 = _interopRequireDefault(_HtmlTable2);
 ...
 */
var LastFmScrobblesTable = function (_HtmlTable) {
  _inherits(LastFmScrobblesTable, _HtmlTable);

  /**
   * Constructs a new HTML table using jQuery.
   * @param {object} parentDOMElement - The parent DOM element that we want to append this table to.
   */
  function LastFmScrobblesTable(parentDOMElement) {
    _classCallCheck(this, LastFmScrobblesTable);

    var _this = _possibleConstructorReturn(this, (LastFmScrobblesTable.__proto__ || Object.getPrototypeOf(LastFmScrobblesTable)).call(this, parentDOMElement));

    _this._columns = ['Song', 'Artist', 'Album', 'Date'];
    _this._rowItemType = _LastFmTrack2.default;
    return _this;
  }

  return LastFmScrobblesTable;
}(_HtmlTable3.default);

exports.default = LastFmScrobblesTable;
